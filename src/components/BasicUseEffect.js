        ...
        <div className="space-y-3">
          ...
          <div className="bg-green-50 p-3 rounded-md border-l-4 border-green-400">
            <p className="text-sm text-gray-700">
              ...
              <span className="font-mono text-green-700 ml-2 break-words text-xs">{message}</span>
            </p>
          </div>
        </div>
        <button 
          className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md transition-colors duration-200 shadow-sm hover:shadow-md"
